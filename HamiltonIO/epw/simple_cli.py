def cli_convert_to_netcdf():
    ...
    parser.add_argument("--convert-netcdf", action="store_true", help="Convert EPW data to NetCDF")
    parser.add_argument("-p", "--path", default=".", help="Path to EPW files (default: current directory)")
    parser.add_argument("-n", "--prefix", default="epw", help="EPW file prefix (default: epw)")
    parser.add_argument("-o", "--output", default="epmat.nc", help="Output NetCDF file (default: epmat.nc)")
