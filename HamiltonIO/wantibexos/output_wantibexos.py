...
if sptype2 == "unpolarized":
    ...
    print(
        ncases(tshs.cell[0, 0]),
        "",
        ncases(tshs.cell[0, 1]),
        "",
        ncases(tshs.cell[0, 2]),
        file=f,
    )
    print(
        ncases(tshs.cell[1, 0]),
        "",
        ncases(tshs.cell[1, 1]),
        "",
        ncases(tshs.cell[1, 2]),
        file=f,
    )
    print(
        ncases(tshs.cell[2, 0]),
        "",
        ncases(tshs.cell[2, 1]),
        "",
        ncases(tshs.cell[2, 2]),
        file=f,
    )
    print(nbasis, file=f)
    print(ncell, file=f)
    ...
    for i in range(0, ncell):
        for j in range(0, nbasis):
            for k in range(0, nbasis):
                ...
                reH[i + 1, (j + 1) + nbasis, (k + 1) + nbasis] = tshs[
                    j, k + i * nbasis
                ][1]
    ...
    for i in range(0, ncell):
        for j in range(0, nbasis):
            for k in range(0, nbasis):
                ...
                imH[i + 1, (j + 1) + nbasis, (k + 1) + nbasis] = tshs[
                    j, k + i * nbasis
                ][5]
                S[i + 1, (j + 1) + nbasis, (k + 1) + nbasis] = tshs.S[j, k + i * nbasis]
